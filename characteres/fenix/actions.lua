...
function actions.build()
    ...
    local fireAttack ={
        description = "Lançar bola de fogo",
        requirement = nil,
    ...
    -- Ataque com tornado de fogo
    local tornadoAttack ={
        description = "Ataque com tornado de fogo",
        requirement = nil,
        execute = function (playerData, creatureData)      
             --1. Calcular dano e apresentar resultado como print
             local rawDamage = creatureData.attack - math.random() * playerData.defense
             local damage = math.min(1, math.ceil(rawDamage * 0.4))
    ...
    actions.list[#actions.list+1] = tornadoAttack
